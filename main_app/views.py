...
from .forms import CheckingForm, VisitedPlaceForm
...
def add_visited_place(request):
    context = {
        # whatever data you need to pass, e.g. form = MyForm()
    }
    return render(request, "main_app/add_visited_place.html", context)